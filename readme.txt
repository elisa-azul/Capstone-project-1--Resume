...
2. Use appropriate HTML tags to format the content of each section, such as h1 for section headings and ul or ol for lists.

3. Use HTML tags to add a profile photo of yourself.
...
5. Add a footer element with your name and any copyright information or other disclaimers. (Hint: use the MDN docs for things you don't know how to do: https://developer.mozilla.org/en-US/docs/Web/HTML/Element/footer

7. Save the index.html file and open it in a web browser to ensure that it displays correctly.

8. Add your website to your GitHub to start building your portfolio.

9. Publish your website using GitHub pages and share it here (in the Q&A) with other students.
